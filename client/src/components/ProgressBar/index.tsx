  ...
  return (
    ...
    <div className={`td-progress-bar-wrapper ${className}`}>
      <div
        ...
        //  ts-migrate(2532) FIXME: Object is possibly 'undefined'.
      ...
      <div
        ...
        //  ts-migrate(2322) FIXME: Type '{ position: string; right: string; } | {}' i... Remove this comment to see the full error message
      >
        {/*  ts-migrate(17004) FIXME: Cannot use JSX unless the '--jsx' flag is provided... Remove this comment to see the full error message */}
